import {getJssdkConfig, getWxPayConfig, getShopPayConfig} from '@/services/wx'
 ...
 * }
 */
export const shopPay = function (params) {
  return new Promise(async (resolve, reject) => {
    params.appid = pro.appid
    params.mch_id = pro.mch_id
    params.body = '商城订单'
    params = JSON.stringify(params)
    const wxpayRes = await getShopPayConfig(params)
    if (!wxpayRes.success) {
      return reject({
        text: '提交失败',
        type: 'warn',
